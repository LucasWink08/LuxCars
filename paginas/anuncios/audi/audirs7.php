...
<div class="bg-black p-3">
  ...
  <div class="justify between w-screen flex h-[500px] gap-x-2">
    <div class="justify-left w-[33%] h-full">
       <img src="../../../assets/imagens/cars/imgsanuncios/audi/audirs7/2024-audi-rs7-performance-beach-rear-2-1669663939.avif" alt="" class="w-full h-full object-cover">
    </div>
    <div class="justify-center w-[34%]  h-full">
      <img src="../../../assets/imagens/cars/imgsanuncios/audi/audirs7/2024-audi-rs7-performance-beach-front-2-1669663938.avif" alt="" class="w-full h-full object-cover">
    </div>
    <div class="justify-right w-[33%]  h-full">
      <img src="../../../assets/imagens/cars/imgsanuncios/audi/audirs7/2024-audi-rs7-performance-front-interior-1669663935.avif " alt="" class="w-full h-full object-cover">
    </div>
  </div>
  ...
  <div class="w-[45%] py-10 opacity-90">
    <div class="flex items-center justify-center h-full">
      <div class="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full opacity-80">
        <div class="h-full">
          <p class="text-center text-black text-4xl font-bold mb-6 gtimes">audi rs7 </p>
          <div class="space-y-4 text-2xl text-black gtimes">
            <p><strong class="text-gray-600">Ano:</strong> 2024/2025</p>
            <p><strong class="text-gray-600">Cidade:</strong> ituporanga </p>
            <p><strong class="text-gray-600">Combustível:</strong> Gasolina</p>
            <p><strong class="text-gray-600">KM:</strong> 500</p>
            <p><strong class="text-gray-600">Potência:</strong> 1.280 CV</p>
            <p><strong class="text-gray-600">Motor:</strong> V8 Biturbo 5.0 Litros</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="w-[45%] py-10 gtimes opacity-90 text-black" >
    <div class="flex items-center justify-center h-full">
      <div class="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full opacity-80">
        <h2 class="text-center text-black text-4xl font-bold mb-6">R$1.200.000</h2>
