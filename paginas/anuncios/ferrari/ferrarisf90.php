...
<div class="bg-black p-3">
  ...
  <div class="justify between w-screen flex h-[500px] gap-x-2">
    <div class="justify-left w-[33%] h-full">
       <img src="../../../assets/imagens/cars/imgsanuncios/ferrari/ferrarisf90/0x0-Ferrari_SF90_Stradale_3.webp" alt="" class="w-full h-full object-cover">
    </div>
    <div class="justify-center w-[34%]  h-full">
      <img src="../../../assets/imagens/cars/imgsanuncios/ferrari/ferrarisf90/ferrari_sf90_stradale_frente.webp "alt="" class="w-full h-full object-cover">
    </div>
    <div class="justify-right w-[33%]  h-full">
      <img src="../../../assets/imagens/cars/imgsanuncios/ferrari/ferrarisf90/ferrari-sf90-xx-stradale.jpg " alt="" class="w-full h-full object-cover">
    </div>
  </div>



  <div class="flex justify-between mt-10 px-10 text-black">
  
  <div class="w-[45%] py-10 opacity-90">
    <div class="flex items-center justify-center h-full">
      <div class="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full opacity-80">
        <div class="h-full">
          <p class="text-center text-black text-4xl font-bold mb-6 gtimes">ferrari sf90</p>
          <div class="space-y-4 text-2xl text-black gtimes">
            ...
            <p><strong class="text-gray-600">KM:</strong> 0km</p>
            <p><strong class="text-gray-600">Potência:</strong> 1.000 CV</p>
            <p><strong class="text-gray-600">Motor:</strong> V8 de 4.0 litros biturbo combinado com três motores elétrico</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="w-[45%] py-10 gtimes opacity-90">
    <div class="flex items-center justify-center h-full">
      <div class="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full opacity-80">
        <h2 class="text-center text-black text-4xl font-bold mb-6">R$6.230.000</h2>
