...
<div class="bg-black p-3">
  ...
  <div class="justify between w-screen flex h-[500px] gap-x-2">
    <div class="justify-left w-[33%] h-full">
       <img src="../../../assets/imagens/cars/imgsanuncios/ferrari/ferrari458italia/ferrari-458-italia-4-5-v8-gasolina-f1dct-wmimagem00124933320.webp" alt="" class="w-full h-full object-cover">
    </div>
    <div class="justify-center w-[34%]  h-full">
      <img src="../../../assets/imagens/cars/imgsanuncios/ferrari/ferrari458italia/ferrari-458-italia-4-5-v8-gasolina-f1dct-wmimagem00124954140.webp" alt="" class="w-full h-full object-cover">
    </div>
    <div class="justify-right w-[33%]  h-full">
      <img src="../../../assets/imagens/cars/imgsanuncios/ferrari/ferrari458italia/ferrari-458-italia-4-5-v8-gasolina-f1dct-wmimagem00124975412.webp" alt="" class="w-full h-full object-cover">
    </div>
  </div>
  ...
  <div class="w-[45%] py-10 opacity-90">
    <div class="flex items-center justify-center h-full">
      <div class="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full opacity-80">
        <div class="h-full">
          <p class="text-center text-black text-4xl font-bold mb-6 gtimes">ferrari 458 italia</p>
          <div class="space-y-4 text-2xl text-black gtimes">
            <p><strong class="text-gray-600">Ano:</strong> 2015/2016</p>
            <p><strong class="text-gray-600">Cidade:</strong> Balneário Camboriú</p>
            <p><strong class="text-gray-600">Combustível:</strong> Gasolina</p>
            <p><strong class="text-gray-600">KM:</strong> 2500 rodados </p>
            <p><strong class="text-gray-600">Potência:</strong> 570 CV</p>
            <p><strong class="text-gray-600">Motor:</strong> V8 Biturbo 4499 cilindradas aspirado</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="w-[45%] py-10 gtimes opacity-90 text-black">
    <div class="flex items-center justify-center h-full">
      <div class="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full opacity-80">
        <h2 class="text-center text-black text-4xl font-bold mb-6">R$3.340.000</h2>
