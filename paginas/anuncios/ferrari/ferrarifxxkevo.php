...
<div class="bg-black p-3">
  ...
  <div class="justify between w-screen flex h-[500px] gap-x-2">
    <div class="justify-left w-[33%] h-full">
       <img src="../../../assets/imagens/cars/imgsanuncios/ferrari/ferrari fxxkevo/7qnh660zpzbb1.jpg" alt="" class="w-full h-full object-cover">
    </div>
    <div class="justify-center w-[34%]  h-full">
      <img src="../../../assets/imagens/cars/ferrari/Ferrari_FXX_K_Evo.webp" alt="" class="w-full h-full object-cover">
    </div>
    <div class="justify-right w-[33%]  h-full">
      <img src="../../../assets/imagens/cars/imgsanuncios/ferrari/ferrari fxxkevo/ferrari-fxx-evoluzione-6.webp " alt="" class="w-full h-full object-cover">
    </div>
  </div>
  ...
  <div class="w-[45%] py-10 opacity-90">
    <div class="flex items-center justify-center h-full">
      <div class="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full opacity-80">
        <div class="h-full">
          <p class="text-center text-black text-4xl font-bold mb-6 gtimes">ferrari fxxk evo</p>
          <div class="space-y-4 text-2xl text-black gtimes">
            <p><strong class="text-gray-600">Ano:</strong> 2021/2022</p>
            <p><strong class="text-gray-600">Cidade:</strong> são paulo</p>
            <p><strong class="text-gray-600">Combustível:</strong> Gasolina</p>
            <p><strong class="text-gray-600">KM:</strong> 0km</p>
            <p><strong class="text-gray-600">Potência:</strong> 1050 CV</p>
            <p><strong class="text-gray-600">Motor:</strong> motor V12 híbrido com 6.3 litros</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="w-[45%] py-10 gtimes opacity-90 text-black">
    <div class="flex items-center justify-center h-full">
      <div class="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full opacity-80">
        <h2 class="text-center text-black text-4xl font-bold mb-6">R$18.000.000</h2>
