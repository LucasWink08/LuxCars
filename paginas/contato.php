...
<div class="flex items-center justify-center h-screen">
  <div class="bg-white rounded-xl shadow-2xl p-20 max-w-96 opacity-80">
    <h2 class="gtimes justify-center flex items-center text-black text-3xl">CONTATO</h2><br>
    <form acion="" method="post" class="space-y-4">
         <div>
     ...
     <div>
        <label for="subject" class="block text-black mb-1">Assunto</label>
        <input 
          type="text"
          id="subject"
          name="subject"
      ...
      <div>
        <label for="message" class="block text-black mb-1">Mensagem</label>
        <textarea 
          id="message"
          name="message"
          rows="4"
