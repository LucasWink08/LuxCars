...
<div class="bg-black p-3">
  ...
  <div class="justify between w-screen flex h-[500px] gap-x-2 ">
    <div class="justify-left w-[33%] h-full">
       <img src="../../../assets/imagens/cars/imgsanuncios/bmw/bmwm4gts/2016-BMW-M4-GTS-front-three-quarter-turn-03.webp" alt="" class="w-full h-full object-cover">
    </div>
    <div class="justify-center w-[34%]  h-full">
      <img src="../../../assets/imagens/cars/imgsanuncios/bmw/bmwm4gts/image-placeholder-title.jpg" alt="" class="w-full h-full object-cover">
    </div>
    <div class="justify-right w-[33%]  h-full">
      <img src="../../../assets/imagens/cars/imgsanuncios/bmw/bmwm4gts/10_studio_bmw_m4_gts_innenraum_01.jpg" alt="" class="w-full h-full object-cover">
    </div>
  </div>
  ...
  <div class="w-[45%] py-10 opacity-90">
    <div class="flex items-center justify-center h-full">
      <div class="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full opacity-80">
        <div class="h-full">
          <p class="text-center text-black text-4xl font-bold mb-6 gtimes">bmw m4 gts</p>
          <div class="space-y-4 text-2xl text-black gtimes">
            <p><strong class="text-gray-600">Ano:</strong> 2017/2018</p>
            ...
            <p><strong class="text-gray-600">KM:</strong> 8.900km rodados</p>
            <p><strong class="text-gray-600">Potência:</strong> 493 CV</p>
            <p><strong class="text-gray-600">Motor:</strong> 3.0L turboalimentado I6</p>
          </div>
        </div>
      </div>
    </div>
