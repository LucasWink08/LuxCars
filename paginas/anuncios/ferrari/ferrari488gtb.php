...
<div class="bg-black p-3">
    ...
    <div class="justify-left w-[33%] h-full">
       <img src="../../../assets/imagens/cars/imgsanuncios/ferrari/ferrari488gtb/vehicle_image_1736965953_d41d8cd98f00b204e9800998ecf8427e (1).webp" alt="" class="w-full h-full object-cover">
    </div>
    <div class="justify-center w-[34%]  h-full">
      <img src="../../../assets/imagens/cars/imgsanuncios/ferrari/ferrari488gtb/vehicle_image_1736965950_d41d8cd98f00b204e9800998ecf8427e (2).webp" alt="" class="w-full h-full object-cover">
    </div>
    <div class="justify-right w-[33%]  h-full">
      <img src="../../../assets/imagens/cars/imgsanuncios/ferrari/ferrari488gtb/vehicle_image_1736965955_d41d8cd98f00b204e9800998ecf8427e (1).webp" alt="" class="w-full h-full object-cover">
    </div>
  </div>
  ...
  <div class="w-[45%] py-10 opacity-90">
    <div class="flex items-center justify-center h-full">
      <div class="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full opacity-80">
        <div class="h-full">
          <p class="text-center text-black text-4xl font-bold mb-6 gtimes">ferrari 488 gtb</p>
          <div class="space-y-4 text-2xl text-black gtimes">
            <p><strong class="text-gray-600">Ano:</strong> 2017/2017</p>
            ...
            <p><strong class="text-gray-600">KM:</strong> 15.250</p>
            <p><strong class="text-gray-600">Potência:</strong> 670 CV</p>
            <p><strong class="text-gray-600">Motor:</strong> V8 turbo 3.8 </p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="w-[45%] py-10 gtimes opacity-90 text-black">
    <div class="flex items-center justify-center h-full">
      <div class="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full opacity-80">
        <h2 class="text-center text-black text-4xl font-bold mb-6">R$4.490.000</h2>
